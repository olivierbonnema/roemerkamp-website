...
const featuredArticle = {
  ...
  excerpt:
    "Met veel plezier kondigen wij de eerste close aan van de RKP Pool N2C-2026. In deze close is ruim € 112 miljoen toegezegd door relaties van Lange & Partners. Wij zijn trots op dit resultaat en danken onze relaties voor het vertrouwen in ons en in deze strategie.",
