    ...
    <section className="py-16 bg-white">
      ...
      <div className="mt-6 space-y-4">
        <p className="text-gray-700 leading-relaxed">
          Lange &amp; Partners beoordeelt iedere financieringsaanvraag grondig op zekerheid, terugbetalingscapaciteit en perspectief. Pas wanneer een financiering aan onze criteria voldoet, wordt deze aangeboden aan investeerders.
        </p>
        <p className="text-gray-700 leading-relaxed">
