          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              <p className="text-gray-700 leading-relaxed">
                Lange &amp; Partners is voortgekomen uit ruim 50 jaar ervaring in de bancaire sector.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Acht jaar geleden zijn wij begonnen met het verstrekken van non-bancaire leningen, inmiddels hebben wij meer dan 175 miljoen euro aan financieringen verstrekt.
              </p>
              <p className="text-gray-700 leading-relaxed">
