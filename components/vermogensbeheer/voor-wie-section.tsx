    ...
    <section className="py-16 bg-white">
      ...
      <div className="mt-6 space-y-4">
        <p className="text-gray-700 leading-relaxed">
          Bij Lange & Partners gaan we altijd uit van een win-winsituatie: zowel onze cliënten als wijzelf moeten een goed gevoel hebben bij de samenwerking. Vermogensbeheer draait voor ons niet alleen om rendement, maar vooral om vertrouwen, transparantie en een aanpak die past bij de lange termijn doelen van onze cliënten.
        </p>
        <p className="text-gray-700 leading-relaxed">
