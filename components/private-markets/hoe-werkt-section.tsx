    ...
    <section className="py-16 bg-white">
      ...
      <div className="mt-6 space-y-4">
        <p className="text-gray-700 leading-relaxed">
          Lange Financieel Advies werkt nauw samen met Lange & Partners Vermogensbeheer. Hierdoor kan relatief eenvoudig de koppeling gemaakt worden tussen mensen die tijdelijk op zoek zijn naar financiering en investeerders met vermogen.
        </p>
        <p className="text-gray-700 leading-relaxed">
