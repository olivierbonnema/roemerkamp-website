  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-screen-2xl mx-auto px-10">
        <SectionHeading>Lange & Partners iets voor jou?</SectionHeading>
        ...
        <p className="text-gray-700 leading-relaxed mt-6 max-w-4xl">
          Streef jij naar beheerste groei van je vermogen en een financieel zekere toekomst voor jezelf en je familie? Kom gewoon eens praten. Lange & Partners is exclusief en intensief. Onze aanpak komt het
